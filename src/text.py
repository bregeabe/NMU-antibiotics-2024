...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.bt_Quit = customtkinter.CTkButton(self.left_side_panel, text="Change User", fg_color= '#EA0000', hover_color = '#B20000', command= self.login)
    ...
    def scanning(self):
        self.clear_frame()
        self.bt_from_frame4 = customtkinter.CTkButton(self.right_dashboard, text="categories", command=lambda:print("") )
        self.bt_from_frame4.grid(row=0, column=0, padx=20, pady=(10, 0))

    def requisition(self):
        self.clear_frame()
        self.bt_from_frame5 = customtkinter.CTkButton(self.right_dashboard, text="requisition", command=lambda:print("requisition form") )
        self.bt_from_frame5.grid(row=0, column=0, padx=20, pady=(10, 0))

    def workcard(self):
        self.clear_frame()
        self.bt_from_frame5 = customtkinter.CTkButton(self.right_dashboard, text="workcard", command=lambda:print("workcard form") )
        self.bt_from_frame5.grid(row=0, column=0, padx=20, pady=(10, 0))

    def biochems(self):
        self.clear_frame()
        self.bt_from_frame6 = customtkinter.CTkButton(self.right_dashboard, text="biochems", command=lambda:print("biochems card") )
        self.bt_from_frame6.grid(row=0, column=0, padx=20, pady=(10, 0))
